...
@RestController
@RequestMapping("/tables/todos")
public class TodoTableRestController {

    private TodoTableRepository repo;

    public TodoTableRestController(TodoTableRepository todoRepo) {
        this.repo = todoRepo;
    }
